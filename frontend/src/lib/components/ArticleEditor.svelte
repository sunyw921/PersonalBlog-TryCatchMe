<script>
  ...
  // Handle embedded images selection
  function handleEmbeddedImagesChange(e) {
    ...
    embeddedImageFiles = [...embeddedImageFiles, ...validFiles];
  }
  ...
  function removeEmbeddedImage(index) {
    embeddedImageFiles.splice(index, 1);
    embeddedImageFiles = embeddedImageFiles;
  }
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      embeddedImageFiles.forEach((img) => formData.append("images", img));
      ...
      if (res.ok) {
        ...
        errorMsg = err.error || "Failed to post article";
      }
    } catch (e) {
...
{#if open}
  <!-- Modal overlay with blur and semi-transparent background -->
  <div class="editor-overlay">
    <div class="editor-page">
      ...
      <div class="image-section">
        ...
        {#if embeddedImageFiles.length > 0}
          <div class="images-grid">
            {#each embeddedImageFiles as file, i (i)}
              <div class="image-preview-small">
                ...
                <button
                  ...
                  on:click={() => removeEmbeddedImage(i)}
                  disabled={saving}
                  title="Remove image"
                >
                  ✕
